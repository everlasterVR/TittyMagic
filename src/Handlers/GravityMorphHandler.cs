    ...
    class GravityMorphHandler
    {
        ...
        private void InitGravityMorphs()
        {
            ...
            uprightMorphs = new List<GravityMorphConfig>
            {
                ...
                new GravityMorphConfig("TM_Upright2",                   1.00f,     1.20f,     0.80f),
                ...
                new GravityMorphConfig("TM_Upright3",                   1.00f,     0.00f,     2.00f),
                //new GravityMorphConfig("UPR_Breasts Natural",           0.05f,     0.00f,     2.00f),
            };

            upsideDownMorphs = new List<GravityMorphConfig> {
                new GravityMorphConfig("TM_UpsideDown1",                1.00f,     0.00f,     2.00f),
                ...
                //new GravityMorphConfig("UPSD_Breast Height",            0.33f,     0.00f,     2.00f),
                //new GravityMorphConfig("UPSD_Breast Height Upper",      0.10f,     0.00f,     2.00f),
                ...
                new GravityMorphConfig("TM_UpsideDown2",                1.00f,     0.50f,     1.50f),
                ...
                new GravityMorphConfig("TM_UpsideDown4",                1.00f,     1.00f,     0.00f),
                //new GravityMorphConfig("UPSD_Breast Pointed",           0.25f,     1.00f,     0.00f),

                new GravityMorphConfig("TM_UpsideDown5",                1.00f,     1.50f,     0.50f),
                ...
                new GravityMorphConfig("TM_UpsideDown6",                1.00f,    -1.00f,     1.00f),
            ...
            leanBackMorphs = new List<GravityMorphConfig>
            {
                ...
                //new GravityMorphConfig("LBACK_Breast Depth Squash L",   0.25f,     0.00f,     2.00f),
                //new GravityMorphConfig("LBACK_Breast Depth Squash R",   0.25f,     0.00f,     2.00f),
                //new GravityMorphConfig("LBACK_Breast Diameter",         0.15f,     0.00f,     2.00f),
                //new GravityMorphConfig("LBACK_Breast Height",           0.30f,     0.00f,     2.00f),
                //new GravityMorphConfig("LBACK_Breast Height Upper",     0.10f,     0.00f,     2.00f),
                //new GravityMorphConfig("LBACK_Breast Zero",             0.10f,     0.00f,     2.00f),
                //new GravityMorphConfig("LBACK_Breasts Flatten",         0.25f,     0.00f,     2.00f),
                //new GravityMorphConfig("LBACK_Chest Smoother",          0.30f,     0.00f,     2.00f),

                new GravityMorphConfig("TM_LeanBack2",                  1.00f,     0.50f,     1.50f),
                ...
                //new GravityMorphConfig("LBACK_Breast Top Curve1",      -0.14f,     1.00f,     1.00f),
                //new GravityMorphConfig("LBACK_Breast Top Curve2",      -0.28f,     1.00f,     1.00f),
            ...
            leanForwardMorphs = new List<GravityMorphConfig> {
                new GravityMorphConfig("TM_LeanForward1",               1.00f,     0.50f,     1.50f),
                //new GravityMorphConfig("LFWD_Breast Diameter",         -0.04f,     0.50f,     1.50f),
                //new GravityMorphConfig("LFWD_Breast Diameter L",        0.40f,     0.50f,     1.50f),
                //new GravityMorphConfig("LFWD_Breast Diameter R",        0.40f,     0.50f,     1.50f),
                ...
                //new GravityMorphConfig("LFWD_Breast Rotate Down L",     0.20f,     0.50f,     1.50f),
                //new GravityMorphConfig("LFWD_Breast Rotate Down R",     0.20f,     0.50f,     1.50f),
            ...
            rollLeftMorphs = new List<GravityMorphConfig>
            {
                ...
                new GravityMorphConfig("TM_RollLeft2",                  1.00f,     2.00f,     0.00f),
            ...
            {
                new GravityMorphConfig("TM_RollRight1",                  1.00f,     0.00f,     2.00f),
                ...
                new GravityMorphConfig("TM_RollRight2",                  1.00f,     2.00f,     0.00f),
