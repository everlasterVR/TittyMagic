    ...
    class GravityMorphHandler
    {
        ...
        private void InitGravityMorphs()
        {
            ...
            upsideDownMorphs = new List<GravityMorphConfig> {
                ...
                new GravityMorphConfig("UPSD_Breast Sag2",             -0.05f,     0.00f,     2.00f),
                ...
                new GravityMorphConfig("UPSD_BreastsShape2",            0.33f,     1.50f,     0.50f),
            ...
            leanBackMorphs = new List<GravityMorphConfig>
            {
                ...
                new GravityMorphConfig("LBACK_Breast Height",           0.33f,     0.00f,     2.00f),
                ...
                new GravityMorphConfig("LBACK_Chest Smoother",          0.33f,     0.00f,     2.00f),
                ...
                new GravityMorphConfig("LBACK_Center Gap Smooth",       0.33f,     1.00f,     1.00f),
            };
            ...
            rollLeftMorphs = new List<GravityMorphConfig>
            {
                ...
                //new GravityMorphConfig("RLEFT_Breasts Implants L",      0.03f,     0.00f,     0.00f),
                new GravityMorphConfig("RLEFT_Breasts Implants R",      0.05f,     2.00f,     0.00f),
                new GravityMorphConfig("RLEFT_Centre Gap Narrow",       0.33f,     0.00f,     2.00f),
            ...
            rollRightMorphs = new List<GravityMorphConfig>
            {
                ...
                //new GravityMorphConfig("RRIGHT_Breasts Implants R",     0.03f,     0.00f,     0.00f),
                new GravityMorphConfig("RRIGHT_Centre Gap Narrow",      0.33f,     0.00f,     2.00f),
